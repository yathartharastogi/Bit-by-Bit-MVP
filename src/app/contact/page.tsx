...
import SocialCoins3D from '@/components/three/SocialCoins3D'
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-6 text-left relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 md:gap-12 py-2">
            ...
            <div className="flex flex-col justify-center items-center flex-shrink-0 relative">
              <div className="absolute top-0 lg:-top-2 font-mono text-[10px] text-text-sec uppercase tracking-[0.2em] opacity-80 pointer-events-none">Follow Us On</div>
              
              <div className="hidden md:block">
                <SocialCoins3D />
              </div>
              
              <div className="flex md:hidden gap-6 mt-8 mb-2">
